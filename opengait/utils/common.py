...
def get_ddp_module(module, device, **kwargs):
    ...
    # print('flg_find_unused_parameters', flg_find_unused_parameters)
    # flg_find_unused_parameters = False
    module = DDPPassthrough(module, device_ids=[device], output_device=device,
                            find_unused_parameters=flg_find_unused_parameters, **kwargs)
    return module
